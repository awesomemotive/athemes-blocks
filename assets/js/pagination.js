...
/******/ 	"use strict";
/*!************************************************!*\
  !*** ./assets/js/src/pagination/pagination.js ***!
  \************************************************/
/**
...
athemesBlocks.pagination = {
  ...
  loadMorePosts: function () {
    ...
    ajax.onload = function () {
      if (this.status >= 200 && this.status < 400) {
        ...
        // Masonry
        const is_masonry_layout = typeof Masonry === 'function' && _this.defaults.itemsWrapper.classList.contains('masonry-brick'),
          msnry = is_masonry_layout ? Masonry.data(_this.defaults.itemsWrapper.parentElement) : '';
        const is_shop_masonry_layout = typeof Masonry === 'function' && _this.defaults.itemsWrapper.classList.contains('masonry'),
  ...
  updateNextURL: function () {
    let nextPage = this.defaults.currentPage < this.defaults.totalPages ? this.defaults.currentPage + 1 : this.defaults.currentPage,
...
athemesBlocks.pagination.domReady(setTimeout(function () {
  athemesBlocks.pagination.init();
}, 100));
/******/ })()
;
