...
const LAYOUTS = [
    ...
    {
        name: '4-columns-grid',
        label: __('4 Columns Grid', 'athemes-blocks'),
        content: <div className="columns-icon columns-icon--4-grid">
            <div className="columns-icon__column"></div>
            <div className="columns-icon__column"></div>
            <div className="columns-icon__column"></div>
            <div className="columns-icon__column"></div>
    ...
    },
    {
        ...
        label: __('3 Columns Top Small', 'athemes-blocks'),
        content: <div className="columns-icon columns-icon--3-top-small">
            <div className="columns-icon__column"></div>
            <div className="columns-icon__column"></div>
            <div className="columns-icon__column"></div>
        </div>,
