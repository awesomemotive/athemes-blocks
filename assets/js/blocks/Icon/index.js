...
/* harmony import */ var _block_editor_hoc_with_google_fonts__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ../../block-editor/hoc/with-google-fonts */ "./assets/js/src/block-editor/hoc/with-google-fonts.jsx");
/* harmony import */ var _utils_block_animations__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../../utils/block-animations */ "./assets/js/src/utils/block-animations.jsx");
/* harmony import */ var _utils_settings__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ../../utils/settings */ "./assets/js/src/utils/settings.jsx");
...
const Edit = props => {
  ...
  const {
    ...
    return {
      ...
      // Style.
      alignment: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingValue)('alignment', currentDevice, atts),
      color: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingValue)('color', 'desktop', atts),
      size: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingValue)('size', currentDevice, atts),
      rotate: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingValue)('rotate', currentDevice, atts),
      // Advanced.
      hideOnDesktop: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingValue)('hideOnDesktop', 'desktop', atts),
      hideOnTablet: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingValue)('hideOnTablet', 'desktop', atts),
      hideOnMobile: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingValue)('hideOnMobile', 'desktop', atts)
    };
  }, [atts, currentDevice]);
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_5__.InspectorControls, null, currentTab === 'general' && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.Panel, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_4__.PanelBody, {
    ...
    onClickReset: () => {
      updateAttribute('alignment', {
        value: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingDefaultValue)('alignment', currentDevice, attributesDefaults)
      }, currentDevice);
      setUpdateCss({
        settingId: 'alignment',
        value: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingDefaultValue)('alignment', currentDevice, attributesDefaults)
    ...
    defaultStateOnChangeComplete: value => {
      updateAttribute('color', {
        value: {
          defaultState: value.hex,
          hoverState: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getColorPickerSettingValue)('color', 'desktop', 'hoverState', atts)
        }
      }, 'desktop');
      setUpdateCss({
        settingId: 'color',
        value: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getColorPickerSettingValue)('color', 'desktop', 'defaultState', atts)
      });
    },
    hoverStateOnChangeComplete: value => {
      updateAttribute('color', {
        value: {
          defaultState: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getColorPickerSettingValue)('color', 'desktop', 'defaultState', atts),
          hoverState: value.hex
        }
      }, 'desktop');
      setUpdateCss({
        settingId: 'color',
        value: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getColorPickerSettingValue)('color', 'desktop', 'hoverState', atts)
      });
    },
    onClickReset: () => {
      updateAttribute('color', {
        value: {
          defaultState: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getColorPickerSettingDefaultValue)('color', 'desktop', 'defaultState', attributesDefaults),
          hoverState: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getColorPickerSettingDefaultValue)('color', 'desktop', 'hoverState', attributesDefaults)
        }
      }, 'desktop');
      setUpdateCss({
        settingId: 'color',
        value: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getColorPickerSettingDefaultValue)('color', 'desktop', 'defaultState', attributesDefaults)
      });
    }
    ...
    defaultValue: size,
    defaultUnit: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingUnit)('size', currentDevice, atts),
    min: 1,
    max: 200,
    responsive: true,
    reset: true,
    ...
    onChange: value => {
      updateAttribute('size', {
        value: value,
        unit: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingUnit)('size', currentDevice, atts)
      }, currentDevice);
      setUpdateCss({
        settingId: 'size',
        value: value
    ...
    onClickReset: () => {
      updateAttribute('size', {
        value: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingDefaultValue)('size', currentDevice, attributesDefaults),
        unit: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingDefaultUnit)('size', currentDevice, attributesDefaults)
      }, currentDevice);
      setUpdateCss({
        settingId: 'size',
        value: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingDefaultValue)('size', currentDevice, attributesDefaults)
    ...
    defaultValue: rotate,
    defaultUnit: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingUnit)('rotate', currentDevice, atts),
    min: 0,
    max: 360,
    responsive: true,
    reset: true,
    ...
    onChange: value => {
      updateAttribute('rotate', {
        value: value,
        unit: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingUnit)('rotate', currentDevice, atts)
      }, currentDevice);
      setUpdateCss({
        settingId: 'rotate',
        value: value
    ...
    onClickReset: () => {
      updateAttribute('rotate', {
        value: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingDefaultValue)('rotate', currentDevice, attributesDefaults),
        unit: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingDefaultUnit)('rotate', currentDevice, attributesDefaults)
      }, currentDevice);
      setUpdateCss({
        settingId: 'rotate',
        value: (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingDefaultValue)('rotate', currentDevice, attributesDefaults)
    ...
    // Link.
    const linkUrl = (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getInnerSettingValue)('link', 'linkUrl', '', atts);
    const linkTarget = (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getInnerSettingValue)('link', 'linkTarget', '', atts);
    const linkNoFollow = (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getInnerSettingValue)('link', 'linkNoFollow', '', atts);
    if (linkUrl) {
      Tag = 'a';
    ...
    const {
      icon
    } = (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getInnerSettingValue)('icon', 'iconData', '', atts);
    const IconHTML = () => {
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    ...
    // Font size.
    const hasFontSize = (0,_utils_settings__WEBPACK_IMPORTED_MODULE_22__.getSettingValue)('size', currentDevice, atts) > 0;
    if (hasFontSize) {
    ...
    // Animation.
    blockProps = (0,_utils_block_animations__WEBPACK_IMPORTED_MODULE_21__.blockPropsWithAnimation)(blockProps, attributes);
